    ...
    <>
      <section className="bg-white py-20 lg:py-[120px] relative z-10">
        <div className="container">
          <div className="flex flex-wrap md:-mx-4 lg:justify-between">
            <div className="w-full md:px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0 p-3">
                <span className="block mb-4 font-semibold text-2xl text-gray-800 p-4 border border-x-pink-800 border-t-pink-800 rounded-lg w-44">
                  Contact Us
                </span>
                ...
                Welcome to our Contact Us page! We are delighted to hear from you and eager to assist you with any inquiries, feedback, or concerns you may have. Whether you are interested in our products, have questions about our services, or simply want to share your thoughts, this is the place to get in touch. Our dedicated team is committed to providing exceptional customer support and ensuring that your experience with us is nothing short of outstanding. So, do not hesitate to reach out - we are here to listen, help, and make your interaction with us as seamless as possible. Contact us today and let start a conversation!
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                      Chak# 61 R.B Bedianwala Tehsil Jaranwala District Faisalabad.
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded border-primary bg-gray-700 hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
                ...
                <div>
                  <span className="absolute md:-top-10  md:-right-9 z-[-1]">
                    <svg
                      width={100}
                      height={100}
                      viewBox="0 0 100 100"
                  ...
                  <span className="absolute md:-right-10 top-[90px] z-[-1]">
                    <svg
                      width={34}
                      height={134}
                      viewBox="0 0 34 134"
...
// Function for textarea of the contact page
...
// Fuction for the Input of the contact page
