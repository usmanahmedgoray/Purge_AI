...
// Handle the change in textarea
  ...
  return (
    ...
    <div className="my-4 mt-16 md:mt-0 flex flex-col justify-center items-start h-60 w-[22rem] md:w-[40rem] lg:w-[50rem] xl:w-[65rem]">
          <h1 className="text-5xl text-gray-700 my-6 font-semibold border-l-pink-900 border-r-pink-900 border-t-pink-900 border p-3 rounded-lg">Python Bug Fixer</h1>
          <p className="text-xl text-justify text-gray-600">It is a groundbreaking AI-powered tool that has the ability to automatically find and fix bugs in Python code, making the debugging process more efficient and less time-consuming.</p>
          <p className="text-xl text-justify mt-3 text-gray-600">You can simply provide your python code in prompt section and you shall be get simply bug free Python piece of code through AI</p>
        </div>
    <div className="my-6 flex flex-col items-center">
    <div className="flex justify-start w-full mt-24 md:mt-0">
